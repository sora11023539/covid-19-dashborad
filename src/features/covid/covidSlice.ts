...
const initialState: covidState = {
  data: {
    ...
    lastUpdate: "2022-08-13T09:20:40.000Z",
  },
  country: "",
  dailyData: [
    {
...
// createAsyncThunk("action名", 非同期処理)
// ジェネリクスでデータ型の詳細化を後回しにする
export const fetchAsyncGet = createAsyncThunk("covid/get", async () => {
  // await = Promise(非同期処理の完了の結果)を待つ
  // axios.get = HTTP通信を行い、サーバーからデータを取得する
